...
final class DetailVC: UIViewController {
    ...
    init(dataNote: Notes, changeNote: @escaping (Notes) -> ()) {
        self.dataNote = dataNote
        self.change = changeNote
    ...
    private func setupUI() {
        ...
        nameField.text = dataNote.name
        detailField.text = dataNote.desc
    ...
    @objc private func save() {
        dataNote.name = nameField.text ?? ""
        dataNote.desc = detailField.text ?? ""
        dataNote.edit = Date()
